...
{ 
    ...
    { 
        ...
        { 
          System.Net.HttpWebRequest request = CreateRequest(url, "POST"); 
        ...
        /// <returns></returns> 
        private byte[] GetData(System.Net.HttpWebRequest request) 
        { 
        ...
        private void PostData(System.Net.HttpWebRequest request, byte[] postData) 
        { 
            int offset = 0; 
        ...
        /// <returns></returns> 
        private System.Net.HttpWebRequest CreateRequest(string url, string method) 
        { 
            Uri uri = new Uri(url); 
