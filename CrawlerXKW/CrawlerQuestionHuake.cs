                          ...
                          Parallel.For(1, pageCount + 1, (i) =>
                                   {
                                       ...
                                       var html = HttpWebResponseProxyHuake.ExecuteCreateGetHttpResponseProxy(url, 12000, $" isshowAnswer=false; bankname={source.Prefix};  bankId={source.SubjectId.ToString()};");
